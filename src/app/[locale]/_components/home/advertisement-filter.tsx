...
export default function AdvertisementFilter({
  ...
  return (
    <Card className="rounded-none">
      <CardContent className="py-5 px-5 sm:px-10 flex flex-col sm:flex-row justify-between gap-y-4 gap-x-6 items-center">
        <div className="flex flex-col gap-y-4">
          <h1 className="text-xl sm:text-3xl font-bold">
            {t("advertisement.title")}
          </h1>
          <h2 className="text-md sm:text-lg text-justify">
